...
const CRONOGRAMA = [
  ...
  { data: "27/04", tema: "Discussão de Caso", bib: "Diagnosis - Documentário Netflix (Temporada 1, Episódio 1)", bibAbnt: "Busque exatamente por 'Diagnosis' na barra de pesquisa da sua conta Netflix.", filePreview: null, part: "Profa. Me. Camila Rennhard (@camilarennhard)", eixo: "Psicopatologia e Fármacos", videos: [{ title: "Reflexão sobre Diagnóstico (TikTok 1)", url: "https://vt.tiktok.com/ZSaTAuexN/" }, { title: "Autodiagnóstico (TikTok 2)", url: "https://vt.tiktok.com/ZSaTAysPh/" }] },
